...
SELECT FirstName + ' ' + IsNull(MiddleName,'')+ ' ' + LastName As [Full Name], JobTitle As [JobTitle] FROM Employees 
SELECT * FROM V_EmployeeNameJobTitle
--18.Distinct Job Titles
SELECT DISTINCT JobTitle FROM Employees
--19.Find First 10 Started Projects
SELECT TOP(10)  * FROM Projects  ORDER BY StartDate ,EndDate,[Name]
